...
use VizHAAL\VisplatBundle\VizHAALVisplatBundle;
...
class User implements UserInterface, \Serializable
{
    ...
    /**
     * @var \VizHAAL\VisplatBundle\Entity\Data
     */
    private $data;
     ...
     * Add Role
     *
     * @param \VizHAAL\VisplatBundle\Entity\Role $role
     * @return User
     */
    public function addRole(\VizHAAL\VisplatBundle\Entity\Role $role)
    {
     ...
     * Add RolesCollection
     *
     * @param $role \VizHAAL\VisplatBundle\Entity\Role $role
     */
     ...
     * @param \VizHAAL\VisplatBundle\Entity\Role $role
     */
    public function removeRole(\VizHAAL\VisplatBundle\Entity\Role $role)
    {
        // Link each role with the user
     ...
     * @param $roles \VizHAAL\VisplatBundle\Entity\Role $role
     * @return $user
     */
...
//            $this->roles
     ...
     * Set data
     *
     * @param \VizHAAL\VisplatBundle\Entity\Data $data
     * @return User
     */
    public function setData(\VizHAAL\VisplatBundle\Entity\Data $data = null)
    {
        $this->data = $data;
     ...
     * Get data
     *
     * @return \VizHAAL\VisplatBundle\Entity\Data
     */
