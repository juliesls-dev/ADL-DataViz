...
namespace VizHAAL\VisplatBundle\Administrator;


use VizHAAL\VisplatBundle\Repository\UserRepository;
    ...
    protected function configureFormFields(FormMapper $formMapper)
    {
        $formMapper
            ...
            ->add('rolesCollection','entity',array(
                'class' => 'VizHAALVisplatBundle:Role',
                'property'=>'name',
                'expanded' => true,
                'compound' => true,
                'multiple' => true,
            ...
            ->add('doctorID', 'entity', array(
                'class' => 'VizHAALVisplatBundle:User',
                'property' => 'name',
                'label' => 'Doctor\'s name',
